...
$router->post('/get_orders', 'pos/get_orders.php')->only('admin');
$router->post('/store_payment', 'pos/store_payment.php')->only('admin');
$router->post('/onsite_payment', 'pos/onsite_payment.php')->only('admin');
